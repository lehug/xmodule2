...
public class DefaultSpringAppPostInitializer extends SpringAppInitializeSupport implements ApplicationContextAware, EnvironmentAware, MessageSourceAware, ServletContextAware {
	...
	public void setServletContext(ServletContext servletContext) {
		...
		setFinalFieldValue(ApplicationConstants.class, "CONTEXT_PATH", FileUtils.formatPath(servletContext.getContextPath()));
		setFinalFieldValue(ApplicationConstants.class, "CONTEXT_REAL_PATH", FileUtils.formatPath(servletContext.getRealPath("/")));
