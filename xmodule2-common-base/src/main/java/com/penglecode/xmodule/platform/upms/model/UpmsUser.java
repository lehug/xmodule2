...
public class UpmsUser implements BaseModel<UpmsUser> {
	...
	public UpmsUser decode() {
        ...
        if (userIcon != null && !userIcon.trim().equals("")) {
        	...
        	if(userIconUrl.equals(UpmsConstants.DEFAULT_USER_AVATAR.value()) || userIconUrl.toLowerCase().startsWith("http")){ //默认的头像或者以http开头的全url路径头像
        		//nothing to do
