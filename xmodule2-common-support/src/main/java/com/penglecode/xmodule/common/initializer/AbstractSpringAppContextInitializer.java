 ...
 * @version  	1.0
 */
public abstract class AbstractSpringAppContextInitializer extends SpringAppInitializeSupport implements ApplicationContextInitializer<ConfigurableApplicationContext> {
