...
/**
 * SpringBoot事件监听器基类，用于在此时机做一些初始化操作
 * 
 * @author 	pengpeng
 * @date	2019年6月13日 下午2:04:54
 */
public abstract class AbstractSpringBootEventListener<T extends SpringApplicationEvent> implements ApplicationListener<T>, ApplicationContextAware {
